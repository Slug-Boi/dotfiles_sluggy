...
--
--       -- Keymaps
--       u.nmap("<leader>t", "<cmd>TelekastenPanel<cr>")
--       u.nmap("<leader>tn", "<cmd>NewNote<cr>")
--       u.nmap("<leader>tf", "<cmd>FindNotes<cr>")
--       u.nmap("<leader>tg", "<cmd>SearchNotes<cr>")
--       u.nmap("<leader>tz", "<cmd>FollowLink<cr>")
--     end,
--   }
-- }
